...
const Sales = () => {
  ...
  const AllProducts = gender === "male" ? ProductsMale : ProductsFemale;
  const Products = (AllProducts ?? []).filter(
    (product: { old_price: string }) => product.old_price !== ""
  );
  ...
  return (
    <div className="pt-24 pb-8 sm:pt-28 lg:pt-36 px-[5%]">
      <div className="women-placeholder text-center py-3  lg:py-5 text-white">
        <h1 className="text-[1.3rem] ssm:text-[1.5rem] sm:text-[1.8rem] md:text-[2.2rem] lg:text-[2.5rem]">
          {gender === "male" ? "DISCOUNT SALES" : "DISCOUNT SALES"}
        </h1>
      </div>
            ...
            {isLoading ? (
              ...
              <div>
                {filteredProducts && filteredProducts.length > 0 ? (
                  <section className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-x-[5%] gap-y-6 sm:gap-y-10">
                        ...
                        >
                          <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 pt-2 items-start sm:items-center justify-between">
                            ...
                            <div className="flex gap-2 items-center">
                              ...
                              <p className="text-[0.75rem] text-gray-500 line-through font-medium">
