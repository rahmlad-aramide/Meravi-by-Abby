...
import { useGetProductsyBrands } from "../../ApiCalls/getProductsByBrands";
...
const BrandsSpecificPage = () => {
  ...
  const { specificBrand } = location.state || {specificBrand: []}
  // console.log("brands specific", specificBrand);

  const { isLoading: isLoadingMale, data: productsDataMale } =
    useGetProductsyBrands(specificBrand?._id, "male");
  const { isLoading: isLoadingFemale, data: productsDataFemale } =
    useGetProductsyBrands(specificBrand?._id, "female");
  ...
  // console.log("gender brands page", gender);
    ...
    >
      <div className="women-placeholder text-center py-3  lg:py-5 text-white">
        <h1 className="text-[1.3rem] ssm:text-[1.5rem] sm:text-[1.8rem] md:text-[2.2rem] lg:text-[2.5rem]">
          {gender === "male" ? specificBrand?.name : specificBrand?.name}
        </h1>
      </div>
      ...
      <div className="">
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-[5%] mt-0 sm:mt-8 ">
          ...
          <section className="w-[100%] sm:w-[30%] lg:w-[20%] z-[2] bg-white sm:bg-transparent mt-4 sm:mt-0 bg max-h-full sm:max-h-[70vh] sticky top-12 sm:top-28 lg:top-36 flex items-center flex-row-reverse sm:flex-col gap-2 ">
            ...
            {/* Filter section */}
            <section className=" pb-1 hidden sm:pb-0 sm:flex  w-full flex-row gap-0 sm:gap-1   justify-between sm:justify-start sm:flex-col  sm:overflow-y-auto sm:pr-[10%]   ">
              {/* Categories filter */}
              <div className=" py-1">
                <section
                ...
                >
                  <p className="text-[0.9rem] ssm:text-[1.1rem] font-medium">Categories</p>
                  <div
                      ...
                      >
                        ...
                        >
                          <div className=" flex flex-col mt-[7%] gap-1  items-center ">
                            <h2 className=" font-medium leading-none h-8 text-center text-[1rem] hover:text-blue-500 hover:underline lg:text-[1.1rem] ">
...
export default BrandsSpecificPage;
